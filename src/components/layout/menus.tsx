    ...
    >
      {menuItems.map(item => (
        <Link
          ...
          href={item.href || '#'}
          className={cn(
            'group text-muted-foreground relative inline-flex items-center gap-2 px-4 py-2 text-sm font-medium transition-all duration-200',
            ...
            vertical &&
              'w-full px-3 py-2.5 before:top-0 before:bottom-auto before:left-0 before:h-full before:w-0.5 hover:before:h-full'
          )}
        >

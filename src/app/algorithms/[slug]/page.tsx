...
export default async function AlgorithmDetailPage({ params }: Props) {
  ...
  return (
    <div className="bg-background selection:bg-primary/20 min-h-screen pb-32 font-sans text-foreground">
      {/* Header */}
      ...
      <main className="container relative z-10 mx-auto max-w-7xl px-6 py-12">
        <TooltipProvider>
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_300px] xl:gap-24">
            <div className="mx-auto w-full max-w-4xl space-y-16 min-w-0">
              {/* Hero Section */}
              <div className="space-y-8 text-center sm:text-left">
                ...
                <div className="space-y-4">
                  <h1 className="bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text pb-2 text-5xl font-bold tracking-tight text-transparent sm:text-6xl md:text-7xl">
                    {algorithm.name}
                  </h1>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 sm:grid-cols-4 sm:gap-6">
                  ...
                  <Card className="bg-card/50 border-white/10 backdrop-blur-sm">
                    <CardContent className="p-4 space-y-2">
                      ...
                      <div className={`text-xl font-bold tracking-tight ${algorithm.stable ? 'text-green-500' : 'text-orange-500'}`}>
